...
({
    doInit: function (component, event, helper) {
        ...
        let action = component.get("c.approve");
        action.setParams({
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log(status);
                if (status === 'Success') {
                    helper.showToast('Success!', 'Candidate is approve', 'success', null);
                } else if (status === 'Approved') {
                    helper.showToast('Warning!', 'The candidate has already been approved earlier', 'info', null);
                } else if (status === 'Rejected') {
                    helper.showToast('Warning!', 'The candidate cannot be approved because it was previously rejected', 'info', null);
                } else {
